...
components/features/
  ...
  analytics/
    ad-audit-content.tsx, ad-audit-*.tsx
  activity/
    logs-content.tsx
  leads/
    leads-content.tsx
  dashboard/
    dashboard-content.tsx, dashboard-*.tsx
  health/
...
Configured in `next.config.ts` (permanent, query string preserved). No App Router stub pages.
